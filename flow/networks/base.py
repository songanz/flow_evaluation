...
class Network(object):
    ...
    * Network data can be collected from an sumo-specific network (.net.xml)
    ...
    def __init__(self,
        ...
        # file is specified
            ...
            if 'rou' in net_params.template:
                ...
                colors = self._get_colors(vtypes)
                ...
                for t in vtypes:
                    if t == 'Agent':
                        ...
                        vehicles.add(veh_id=t, car_following_params=cf[t],
                                     lane_change_params=lc[t], num_vehicles=0, color=colors[t])
                    # vehicles.add(veh_id=t, car_following_params=cf[t],
                    #              lane_change_params=lc[t], num_vehicles=0, color=colors[t])
    ...
    @staticmethod
    def _get_colors(vtypes):
        ret = {}
        for typ in vtypes:
            ret[typ] = vtypes[typ]['color']
